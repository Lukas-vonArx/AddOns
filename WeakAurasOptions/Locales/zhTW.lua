...
-- WeakAuras/Options
	...
	L["%s X offset by %d"] = "%s 水平偏移 %d"
	L["%s Y offset by %d"] = "%s 垂直偏移 %d"
	L["%s Zoom: %d%%"] = "%s檢視大小: %d%%"
	L["%s, Border"] = "%s, 邊框"
...
從第二到第十一次事件開始每三次事件：2-11/3]=]
	...
	L["Texture Wrap"] = "材質包覆"
	L["Texture X Offset"] = "材質水平偏移"
	L["Texture Y Offset"] = "材質垂直偏移"
